  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "neo-warmth": "linear-gradient(135deg, hsl(355 65% 52%) 0%, hsl(350 55% 48%) 100%)",
      ...
      boxShadow: {
        "neo-glow": "0 0 20px hsl(var(--neo-blue) / 0.4), 0 0 40px hsl(var(--neo-blue) / 0.2), 0 20px 40px hsl(0 0% 0% / 0.5)",
        "neo-glow-lg": "0 0 32px hsl(var(--neo-blue) / 0.5), 0 0 64px hsl(var(--neo-blue) / 0.3), 0 28px 56px hsl(0 0% 0% / 0.6)",
        "neo-glow-intense": "0 0 48px hsl(var(--neo-blue) / 0.6), 0 0 80px hsl(var(--neo-blue) / 0.3)",
