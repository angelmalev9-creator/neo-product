  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        neo: {
          lime: "hsl(var(--neo-lime))", "lime-glow": "hsl(var(--neo-lime-glow))",
      ...
      backgroundImage: {
        "neo-gradient": "linear-gradient(145deg, hsl(220 16% 4%) 0%, hsl(220 14% 8%) 100%)",
        "neo-card-gradient": "linear-gradient(145deg, hsl(220 14% 8% / 0.95) 0%, hsl(220 16% 5% / 0.9) 100%)",
      },
      boxShadow: {
        "neo-glow": "0 0 25px hsl(var(--primary) / 0.4), 0 25px 50px hsl(0 0% 0% / 0.5)",
        "neo-glow-lg": "0 0 40px hsl(var(--primary) / 0.5), 0 35px 70px hsl(0 0% 0% / 0.6)",
        "neo-card": "0 0 20px hsl(var(--primary) / 0.06), 0 30px 60px hsl(0 0% 0% / 0.6)",
      },
    },
  },
