...
const faqs = [
  ...
  {
    q: 'Мога ли да видя записите на разговорите?',
    a: 'Да. Всеки разговор се пази в дашборда с пълен запис. Можете да го прочетете по всяко време.',
  },
  {
  ...
  },
  {
    ...
    a: 'NEO се свързва директно с вградения календар в дашборда. За други системи — свържете се с нас. Работим по интеграции с най-популярните платформи.',
  },
];
