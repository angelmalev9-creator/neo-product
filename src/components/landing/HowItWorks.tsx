...
const steps = [
  {
    icon: Globe,
    number: '01',
    title: 'Въведете адреса на сайта',
    desc: 'Посочвате URL-а и NEO прочита всичко — услуги, цени, работно време, детайли за контакт.',
  ...
  },
  {
    icon: Brain,
    number: '02',
    title: 'NEO научава бизнеса Ви',
    desc: 'За секунди NEO разбира какво предлагате и е готов да отговаря като опитен рецепционист с маркетинг умения.',
    detail: 'Без сложна настройка',
  ...
  },
  {
    icon: Code2,
    number: '03',
    title: 'Поставяте 1 ред код',
    desc: 'Копирате един скрипт таг, поставяте го на сайта — NEO заработва моментално и поема клиентите Ви.',
    detail: 'Copy-paste — готово',
