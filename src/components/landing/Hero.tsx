import { Play, ArrowRight, Mic, Calendar, MessageSquare, Phone, BarChart3, Users, Clock, TrendingUp } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-center">
          ...
          <div className="max-w-lg">
            ...
            <motion.h1
              ...
              className="text-2xl leading-[1.1] sm:text-3xl md:text-[2.25rem] lg:text-[2.5rem] font-display font-black text-foreground tracking-tight mb-4"
            >
            ...
            {/* CTAs */}
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }} className="flex flex-col sm:flex-row gap-2.5 mb-6">
              <Button
