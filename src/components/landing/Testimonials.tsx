...
const testimonials = [
  {
    ...
    content: 'Най-неудобното беше, че хора звъняха в 8 сутринта, преди да отворим, и просто не ги хващахме. Сега NEO им записва час още докато си пием кафето. За един месец имаме 40 нови пациенти, които иначе щяхме да изпуснем.',
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <p className="neo-subheading text-muted-foreground max-w-md mx-auto">
            Бизнеси, които вече използват NEO.
          </p>
        </div>
